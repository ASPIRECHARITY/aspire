Contributing to Aspire Core
============================

The Aspire Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Aspire Core project, and is not to be
confused with overall Aspire Network Protocol consensus changes.

Whether a pull request is merged into Aspire Core rests with the project merge
...
Patches that change Aspire consensus rules are considerably more involved than
...
Where a patch set proposes to change the Aspire consensus, it must have been
...
The project leader is the release manager for each Aspire Core release.
