...
In order to support loading of multiple wallets in aspire-qt, a few changes in the UI architecture will be needed.
...
----------------------
aspire.cpp is the entry point into aspire-qt, and as such, will require some minor modifications to provide hooks for
