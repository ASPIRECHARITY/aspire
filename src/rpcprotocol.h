...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! Aspire is not connected
    ...
    RPC_WALLET_PASSASPIREASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
