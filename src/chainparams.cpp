...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000057d323882dd850984baa4faf5d607546ecb52db1deb6cbbb9899d7f6b6"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1545181331, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("043d1e7ab868d6d450ab4dab97e986e806226e5e6fe686c88c3d6bd0cda3a7046c19a4f334a257dd573a56433ac2197d5d94dca7bfe4b1235d0171dd1e5fd1d8cc");
        nDefaultPort = 8320;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 Aspire starting difficulty is 1 / 2^12
        ...
        nMaxMoneyOut = 2500000 * COIN;
        nLastPOWBlock = 200;
        nModifierUpdateBlock = 999999999;
        nZerocoinStartHeight = 999999999;
        nAccumulatorStartHeight = 1;
        nZerocoinStartTime = 1627974340;
        nBlockEnforceSerialRange = 1; //Enforce serial range starting this block
        nBlockRecalculateAccumulators = ~1; //Trigger a recalculation of accumulators
        nBlockFirstFraudulent = ~1; //First block that bad serials emerged
        nBlockLastGoodCheckpoint = ~1; //Last valid accumulator checkpoint
        const char* pszTimestamp = "Be authentic. You cannot grow if you are not true to yourself";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1545181331;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 556643;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000057d323882dd850984baa4faf5d607546ecb52db1deb6cbbb9899d7f6b6"));
        assert(genesis.hashMerkleRoot == uint256("0x786bce8262368832a86bd0e9930d699f65a01019900200099e01abbca6fdbe92"));

	vSeeds.push_back(CDNSSeedData("76.74.178.176", "76.74.178.176"));
        vSeeds.push_back(CDNSSeedData("69.172.212.36", "69.172.212.36"));
        vSeeds.push_back(CDNSSeedData("76.74.178.175", "76.74.178.175"));
	...
	strSporkKey = "048D9DFDE6740715A0F036CCDFC0CD5C02F7822E2B8649D6DC0F9CD5A7817CFB463861A6DFA9936F9410463FBF65EDC5F89D193C31015D20F893439087F28D2FF7";
        strObfuscationPoolDummyAddress = "AVHfjGak7upy7J8aa2REWghsEjmBVJmgGe";
        nStartMasternodePayments = 1545181331;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Aspire: 1 day
        nTargetSpacing = 1 * 60;  // Aspire: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet aspire addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet aspire script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet aspire BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet aspire BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet aspire BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nTargetSpacing = 1 * 60;        // Aspire: 1 minutes
