...
// Copyright (c) 2017-2018 The Aspire developers
...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total aspire balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zASPIREsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zASPIRE denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zASPIRE denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zASPIRE denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zASPIRE denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zASPIRE denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zASPIRE denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zASPIRE denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zASPIRE denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zASPIRE denominations\n"
            "  }\n"
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zaspireObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zaspireObj.emplace_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.emplace_back(Pair("zASPIREsupply", zaspireObj));
