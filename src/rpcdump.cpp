...
Value bip38encrypt(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38encrypt \"aspireaddress\"\n"
            "\nEncrypts a private key corresponding to 'aspireaddress'.\n"
            "\nArguments:\n"
            "1. \"aspireaddress\"   (string, required) The aspire address for the private key (you must hold the key already)\n"
