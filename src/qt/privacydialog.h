...
public:
    ...
    void setZAspireControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzASPIRE_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzASPIRE_clicked();
    void on_pushButtonZAspireControl_clicked();
