...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted Aspire to zASPIRE");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zASPIRE");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received Aspire from zASPIRE");
    case TransactionRecord::ZerocoinSpend_Change_zASPIRE:
        return tr("Minted Change as zASPIRE from zASPIRE Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zASPIRE to Aspire");
