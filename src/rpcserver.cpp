...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"aspire", "listmasternodes", &listmasternodes, true, true, false},
        {"aspire", "getmasternodecount", &getmasternodecount, true, true, false},
        {"aspire", "masternodeconnect", &masternodeconnect, true, true, false},
        {"aspire", "masternodecurrent", &masternodecurrent, true, true, false},
        {"aspire", "masternodedebug", &masternodedebug, true, true, false},
        {"aspire", "startmasternode", &startmasternode, true, true, false},
        {"aspire", "createmasternodekey", &createmasternodekey, true, true, false},
        {"aspire", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"aspire", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"aspire", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"aspire", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"aspire", "getmasternodescores", &getmasternodescores, true, true, false},
        {"aspire", "mnbudget", &mnbudget, true, true, false},
        {"aspire", "preparebudget", &preparebudget, true, true, false},
        {"aspire", "submitbudget", &submitbudget, true, true, false},
        {"aspire", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"aspire", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"aspire", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"aspire", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"aspire", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"aspire", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"aspire", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"aspire", "checkbudgets", &checkbudgets, true, true, false},
        {"aspire", "mnsync", &mnsync, true, true, false},
        {"aspire", "spork", &spork, true, true, false},
        {"aspire", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"aspire", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
